...
@filter_control
Scenario: Search for Huge Dimensions on Filter Control accepts multiline input
...
@focus_control
Scenario: Search for Huge Dimensions on Focus Control accepts multiline input
	Given I select a huge dimension for focus
	  And I have entered "multiline input" into the Search bar
	 Then I should see the "multiline input" items in the Search bar

@single_time_control
Scenario: Search for Huge Dimensions on Single Time Control accepts multiline input
	Given I select a huge dimension for single-time filtering
	  And I have entered "multiline input" into the Search bar
	 Then I should see the "multiline input" items in the Search bar

@filter_control
Scenario: Search for Non-Huge Dimensions on Filter Control accepts multiline input
	Given I select a non huge dimension for filtering
	  And I have entered "multiline input" into the Search bar
	 Then I should see the "multiline input" items in the Search bar

@focus_control
Scenario: Search for Non-Huge Dimensions on Focus Control accepts multiline input
	Given I select a non huge dimension for focus
	  And I have entered "multiline input" into the Search bar
	 Then I should see the "multiline input" items in the Search bar

Scenario: Clear button available for Non-Huge Dimensions on Filter Control
...
Scenario: Clear button available for Huge Dimensions on Filter Control
